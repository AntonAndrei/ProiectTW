 ...
 <head>
  ...
  ?>
   ...
   <span>
    ...
    <h2 class="cTitle"> BILLS
    <h3 class="cText">  Track your bills and always keep track of how much
						you have to pay. You can also track the bills for a group
						such as your family or your workplace.</h3>
    </h2>
    </div>
